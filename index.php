...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="content">
			<?php $paso = 0; require($_SERVER['DOCUMENT_ROOT']."/minimizar/inc/menu.inc.php"); ?>
			<div id="contentarea">
				...
				<ul>
					<li>Formato <a href="http://es.wikipedia.org/wiki/CSV">CSV</a> (Comma-Separated Values).</li>
					<li>Formato <a href="http://es.wikipedia.org/wiki/JSON">JSON</a> (JavaScript Object Notation).</li>
					<li>Creación del autómata <span style="color: #4BA4C2">en línea</span>.</li>
		      	</ul>
		      	<small>En lo personal recomiendo el formato JSON o hacerlo en línea ya que en ocaciones CSV falla en cuestión de símbolos</small>
			</div>

			<div id="right">
				<h2>Subir un archivo</h2>
				<p>
					<form method="POST" action="/minimizar/minimizar.php" enctype="multipart/form-data">
						<h4>Archivo: </h4><input type="file" name="automata" />
						<input type="submit" value="Subir Autómata" />
					</form>
					<p>
						<span style="color: #4BA4C2">Nota</span>: Por favor verifique que la extensión del archivo de texto 
				...
				<p>
					<form method="POST" action="/minimizar/definir.php">
